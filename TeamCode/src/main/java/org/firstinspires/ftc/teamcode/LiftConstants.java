...
public class LiftConstants {
    ...
    public static int HighBucket = 2000;
    public static int LowRung = 600;
    public static int HighRung = 1200;
    public static int liftRetracted =0;
    public static int liftHang = 400;

    public static int[] liftFlat = {1550, 1500, 1450, 1400};

    public static int LiftSpickup = 330;

    public static int BarAuto = 1200;

    public static int SpecimanDrop = 1400;
    public static int SpecimanDropAuto1= 850;
    public static int SpecimanDropAuto2= 750;
    public static int SpecimanDropAuto3 = 650;
