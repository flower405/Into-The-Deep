...
public class LiftConstants {
    ...
    public static int liftbackup = 550;
    ...
    public static int HAuto = 100;
    public static int Hlow = 500;
    public static int Hmedium = 850;
    ...
    public static double ArmBucketAuto = 0.85;
    public static double ArmWall = 0;
    public static double ArmRung = 0.56;
