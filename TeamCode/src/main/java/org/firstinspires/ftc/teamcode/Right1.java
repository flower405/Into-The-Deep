...
// drops 1 specimen before pushing samples
@Autonomous
public class Right1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder Specimen2Pickup = Specimen1.endTrajectory().fresh() // push all the samples in and pickup 3rd specimen
        ...
        TrajectoryActionBuilder Specimen2 = Specimen2Pickup.endTrajectory().fresh() // hang third specimen
        ...
        TrajectoryActionBuilder Specimen3Pickup = Specimen2.endTrajectory().fresh() // pickup 4th specimen
        ...
        TrajectoryActionBuilder Specimen3 = Specimen3Pickup.endTrajectory().fresh() // placing fourth specimen
        ...
        TrajectoryActionBuilder Specimen4Pickup = Specimen3.endTrajectory().fresh() // picking up the fifth specimen
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(40, -56.5), Math.toRadians(270));

        Action TrajectoryActionSpecimen4Pickup = Specimen4Pickup.build();

        TrajectoryActionBuilder Specimen4 = Specimen4Pickup.endTrajectory().fresh() // placing fifth specimen
        ...
        TrajectoryActionBuilder Specimen5Pickup = Specimen4.endTrajectory().fresh() // Pickup second preload
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(37, -45), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(40, -56.5), Math.toRadians(270));
        ...
        TrajectoryActionBuilder Specimen5 = Specimen5Pickup.endTrajectory().fresh() // place second specimen
                .splineToConstantHeading(new Vector2d(37, -45), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(8, -30), Math.toRadians(90));
        ...
        Actions.runBlocking(
                new ParallelAction(
                        ...
                        new SequentialAction(
                                ...
                                new ParallelAction( // push all the samples and pickup 2 specimen
                                        TrajectoryActionSpecimen3Pickup,
                                        new ArmRungToWall()
                                ),
                                new ParallelAction( // stop and pickup 2 specimen
                                        new WaitWall(),
                                        new SpecimenPickup()
                                ),
                                ...
                                new ParallelAction( // drive to pickup 3 specimen
                                        TrajectoryActionSpecimen4Pickup,
                                        new ArmRungToWall()
                                ),
                                new ParallelAction( // stop and pickup specimen 3
                                        new WaitWall(),
                                        new SpecimenPickup()
                                ),
                                new ParallelAction( // drive to drop specimen 3
                                ...
                                new ParallelAction( // drive to pickup specimen 4
                                ...
                                new ParallelAction( // drive to pickup 5 specimen lift ready
                                        TrajectoryActionSpecimen2Pickup,
                                        new ArmRungToWall()
                                ),
                                new ParallelAction( // stop at wall and pickup 5 specimen
                                        new WaitWall(),
                                        new SpecimenPickup()
                                ),
                                ...
                                new ParallelAction( // stop and drop specimen 5
                                        new WaitBar(),
                                        new SpecimenDrop(),
                                        new InstantAction(() -> liftHeight = SpecimenDrop)
                                ),
