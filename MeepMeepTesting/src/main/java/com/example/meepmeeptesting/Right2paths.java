...
public class Right2paths  {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(10, -68, Math.toRadians(90)))
                ...
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(0)) // pickup second specimen
                ...
                .splineToConstantHeading(new Vector2d(40, -40), Math.toRadians(180)) // place third Specimen
                .splineToConstantHeading(new Vector2d(10, -40), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(6, -30), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(0)) // pickup fourth speciman
                .splineToConstantHeading(new Vector2d(37, -45), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(40, -56.5), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(37, -45), Math.toRadians(180))//place fourth specimen
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(6, -30), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(12, -45), Math.toRadians(0)) // pickup fifth speciman
                .splineToConstantHeading(new Vector2d(37, -45), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(40, -56.5), Math.toRadians(270))
